...
unionevent = UNION deadevents,aliveevents;
filtered = FILTER unionevent BY value is not null;
...
features = FOREACH normalized GENERATE features::patientid AS patientid, features::idx AS idx, ((DOUBLE)featurevalue/(DOUBLE)maxvalues) as normalizedfeaturevalue;
